 ...
 * @version 0.0.3
 */
class GridFsStorage extends node_events_1.EventEmitter {
    ...
    static generateBytes() {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                node_crypto_1.default.randomBytes(16, (error, buffer) => {
                    if (error) {
                        reject(error);
                        return;
                    }
    ...
    fromMulterStream(readStream, request, file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                (0, pump_1.default)([readStream, writeStream]);
            });
        });
    }
    /**
    ...
    _connect() {
        ...
        if (db && !(0, is_promise_1.default)(db) && !(0, is_promise_1.default)(client)) {
    ...
    _setDb(db, client) {
        ...
        this.db = (0, utils_1.getDatabase)(db);
        if (client) {
            this.client = client;
        }
    ...
    _generate(request, file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            else if ((0, is_generator_1.default)(this._file)) {
                isGen = true;
